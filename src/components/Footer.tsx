      ...
      <div className="container mx-auto px-4 grid md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <p 
            ...
            `}
          >
            Your ultimate destination for premium nutrition and wellness supplements. 
            Empowering fitness enthusiasts with high-quality nutritional solutions.
          </p>
      ...
      >
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8 mb-4">
          {[
            ...
            { Icon: FaMapMarkerAlt, text: 'Shop No-24, Ground Floor Galleria Market, Gaur City 2, Greater Noida (W)' }
          ].map(({ Icon, text }, index) => (
            <div 
              key={index} 
              className={`
