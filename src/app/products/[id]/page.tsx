        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <div className="flex items-center mb-3">
              <span
                className={`text-sm font-medium px-2 py-0.5 rounded mr-2 ${
                  theme === "light"
                        ...
                        selectedVariant === variant
                          ? `${
                              theme === "light"
                                ...
                                : "border-yellow-600 bg-yellow-900 bg-opacity-20 text-yellow-300"
                            }`
                          : `${
                              theme === "light"
              ...
              <div className="flex items-center">
                ...
                <div
                  className={`w-14 h-10 flex items-center justify-center ${
                    theme === "light"
                      ? "bg-white border-y border-gray-300 text-gray-900"
                      : "bg-gray-800 border-y border-gray-700 text-white"
                  }`}
                >
                  {quantity}
                </div>
