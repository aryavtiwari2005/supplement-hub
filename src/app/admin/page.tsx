...
export default function AdminPanel() {
  ...
  const editProduct = async (product: any) => {
    ...
    const newOriginalPrice = prompt('Enter original price (optional):', product.original_price?.toString() || '');
    const newDiscountPercentage = prompt('Enter discount percentage (optional):', product.discount_percentage?.toString() || '');
    const newRating = prompt('Enter new rating:', product.rating.toString());
    const newDescription = prompt('Enter new description (optional):', product.description || '');

    // If all necessary fields are filled, update the product in Supabase
    if (newName && newBrand && newCategory && newImage && newPrice && newRating) {
      try {
        const updatedData = {
          name: newName,
          brand: newBrand,
          ...
          discount_percentage: newDiscountPercentage ? parseFloat(newDiscountPercentage) : null,
